...
//--- PIO
  ...
  pio_add_program_at_offset (pio, & ws2812_program, prgmOffset) ;
}
...
void loop() {
  if (gDeadline < millis ()) {
    ...
    lcd.setCursor (0, 1) ;
    lcd.print (gDeadline) ;
    pio_ws2812_set_output (pio, stateMachine, 128, 0, 0) ;
    pio_ws2812_set_output (pio, stateMachine, 0, 128, 0) ;
  }
}
